...
# URL is https://www.espn.co.uk/football/team/results/_/id/team_id/league/ENG.1/season/2025 where team_id
...
team_ids = c("349", "359", "362", "337", "331", "379", "363", "384", "368", "370", "357", "364",
             "382", "360", "361", "393", "366", "367", "371", "380")
...
scrape_results <- function() {
  ...
  for (i in 1:length(team_ids)) {
    ...
    url <- paste("https://www.espn.co.uk/football/team/results/_/id/", team_ids[i], "/league/ENG.1/season/2025", sep = "")
    webpage <- session(url)
